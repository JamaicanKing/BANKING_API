                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customers.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="trn_number" type="trn_number" class="form-control @error('trn_number') is-invalid @enderror" name="trn_number" required autocomplete="trn_number">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id_type" type="id_type" class="form-control @error('id_type') is-invalid @enderror" name="id_type" required autocomplete="id_type">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id_number" type="id_number" class="form-control @error('id_number') is-invalid @enderror" name="id_number" required autocomplete="id_number">
